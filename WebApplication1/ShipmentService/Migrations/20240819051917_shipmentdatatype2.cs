...
{
    /// <inheritdoc />
    public partial class shipmentdatatype2 : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentStatus = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OverallVolume = table.Column<float>(type: "float", maxLength: 50, nullable: false),
                    OverallWeight = table.Column<float>(type: "float", maxLength: 50, nullable: false),
                    OverallCharge = table.Column<float>(type: "float", maxLength: 50, nullable: false),
                    Distance = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
